...
const SPECIALTY_ALIASES = new Map([
  ['alergologia-pediatrica', { name: 'Alergista e Imunologista Infantil', slug: 'alergista-e-imunologista-infantil' }],
  ['cirurgia-pediatrica', { name: 'Cirurgião Pediátrico', slug: 'cirurgiao-pediatrico' }],
  ['dermatologia-pediatrica', { name: 'Dermatologista Infantil', slug: 'dermatologista-infantil' }],
  ['enfermagem-obstetrica', { name: 'Enfermeira Obstétrica', slug: 'enfermeira-obstetrica' }],
  ['endocrinologia-pediatrica', { name: 'Endocrinologista Infantil', slug: 'endocrinologista-infantil' }],
  ['fisioterapia-infantil', { name: 'Fisioterapeuta Infantil', slug: 'fisioterapeuta-infantil' }],
  ...
  ['genetica-medica', { name: 'Geneticista Infantil', slug: 'geneticista-infantil' }],
  ['ginecologia-e-obstetricia', { name: 'Ginecologista e Obstetra', slug: 'ginecologista-e-obstetra' }],
  ['hematologia-pediatrica', { name: 'Hematologista Infantil', slug: 'hematologista-infantil' }],
  ['infectologia-pediatrica', { name: 'Infectologista Infantil', slug: 'infectologista-infantil' }],
  ['musicoterapia-infantil', { name: 'Musicoterapeuta Infantil', slug: 'musicoterapeuta-infantil' }],
  ['nefrologia-pediatrica', { name: 'Nefrologista Infantil', slug: 'nefrologista-infantil' }],
  ['neonatologia', { name: 'Neonatologista', slug: 'neonatologista' }],
  ...
  ['neuropsicologia-infantil', { name: 'Neuropsicólogo Infantil', slug: 'neuropsicologo-infantil' }],
  ['nutricao-infantil', { name: 'Nutricionista Infantil', slug: 'nutricionista-infantil' }],
  ['nutricao-materno-infantil', { name: 'Nutricionista Materno-Infantil', slug: 'nutricionista-materno-infantil' }],
  ['nutrologia-pediatrica', { name: 'Nutrólogo Infantil', slug: 'nutrologo-infantil' }],
  ['odontopediatria', { name: 'Odontopediatra', slug: 'odontopediatra' }],
  ['oftalmologia-pediatrica', { name: 'Oftalmologista Infantil', slug: 'oftalmologista-infantil' }],
  ['ortopedia-pediatrica', { name: 'Ortopedista Infantil', slug: 'ortopedista-infantil' }],
  ['otorrinolaringologia-pediatrica', { name: 'Otorrinolaringologista Infantil', slug: 'otorrinolaringologista-infantil' }],
  ...
  ['pneumologia-pediatrica', { name: 'Pneumologista Infantil', slug: 'pneumologista-infantil' }],
  ['psicologia-infantil', { name: 'Psicóloga Infantil', slug: 'psicologa-infantil' }],
  ['psicologia-perinatal', { name: 'Psicóloga Perinatal', slug: 'psicologa-perinatal' }],
  ['psiquiatria-infantil', { name: 'Psiquiatra Infantil', slug: 'psiquiatra-infantil' }],
  ['reumatologia-pediatrica', { name: 'Reumatologista Infantil', slug: 'reumatologista-infantil' }],
  ...
  ['terapia-ocupacional-infantil', { name: 'Terapeuta Ocupacional Infantil', slug: 'terapeuta-ocupacional-infantil' }],
  ['urologia-pediatrica', { name: 'Urologista Infantil', slug: 'urologista-infantil' }],
])
