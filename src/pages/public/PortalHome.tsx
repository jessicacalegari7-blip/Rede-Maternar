...
export function PortalHome() {
  ...
  return <div className="portal-home">
    ...
    <main className="portal-content">
      ...
      <section className="ecosystem-home"><div className="portal-section-title"><h2>Explore o ecossistema MaterPlace</h2></div><div className="ecosystem-home-grid"><Link to="/marketplace"><span>Marketplace</span><h3>Produtos para maternidade, infância e família</h3><small>Comprar e anunciar com curadoria</small></Link><Link to="/universidade"><span>Universidade</span><h3>Cursos para famílias e profissionais</h3><small>Conhecimento para cada fase</small></Link><Link to="/vagas"><span>Vagas</span><h3>Oportunidades em saúde materno-infantil</h3><small>Encontre a próxima oportunidade</small></Link></div></section>
