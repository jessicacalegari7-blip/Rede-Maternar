...
export function PublicProfessionalProfile() {
  ...
  return <div className="clinic-profile-page">
    ...
    <main className="clinic-profile-shell">
      ...
      {profile.office_video_url&&<section className="clinic-section-card"><h2>Vídeo da clínica</h2><a className="btn btn-secondary" href={profile.office_video_url} target="_blank" rel="noreferrer">Assistir vídeo</a></section>}
