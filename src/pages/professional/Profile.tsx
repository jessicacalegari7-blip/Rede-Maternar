...
import { getMyProfessionalProfile, updateMyProfessionalProfile, type RealProfessionalProfile } from '../../lib/operations'

export function ProfessionalProfilePage() {
  const [profile,setProfile]=useState<RealProfessionalProfile|null>(null)
  const [notice,setNotice]=useState('')
  const [error,setError]=useState('')
  useEffect(()=>{void getMyProfessionalProfile().then(setProfile).catch(e=>setError(e.message))},[])
